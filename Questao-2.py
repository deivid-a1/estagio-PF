...
print(data) #printamos os registros ordenado pelo nome, com o index informando a posição.
...
print(data) #printamos a lista, ordenado pelo nome, com o index informando a posição.
